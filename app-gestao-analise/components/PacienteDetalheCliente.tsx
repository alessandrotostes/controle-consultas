...
export function PacienteDetalheCliente({
  pacienteInicial,
  sessoesIniciais,
}: PacienteDetalheClienteProps) {
  ...
  const handleSalvarEdicao = useCallback(
    ...
    [sessaoEmEdicao, handleFecharModalEdicao, supabase]
  );
  ...
  }, [sessaoEmEdicao, handleFecharDeleteModal, supabase]);
  ...
  const handleSalvarPaciente = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (error) {
        ...
        setPaciente((currentPaciente) => ({ ...currentPaciente!, ...updates }));
        toast.success("Paciente atualizado!");
        handleFecharPacienteModal();
      }
    },
    [paciente.id, pacienteFormData, handleFecharPacienteModal, supabase]
  );
